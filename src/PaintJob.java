public class PaintJob {
    public static void main(String[] args) {
        ...
        System.out.println(getBucketCount(6.26, 2.2));  // → should return 3 since the wall area
        // is 6.26 and a single bucket can cover an area of 2.2.
        System.out.println(getBucketCount(3.26, 0.75));  // → should return 5 since the wall area
        // is 3.26, and a single bucket can cover an area of 0.75 .
    }
...
//
//        1. Write a method named getBucketCount with 4 parameters. The first parameter should be named
