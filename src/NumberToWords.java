...
//
//        The method reverse should have one int parameter and return the reversed number (int). For example, if
//        the number passed is 234, then the reversed number would be 432. The method  reverse should also
...
//        is 001). The logic above for the method numberToWords will print "One", but that is incorrect.
...
//        For example, if the number has a value of 100, the method getDigitCount should return 3 since the number 1
//        00 has 3 digits (1, 0, 0).
//
